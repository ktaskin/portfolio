...
## Projects
- <a href="https://usps-zone-map.vercel.app/" target="_blank" rel="noopener noreferrer"> USPS Zone Map </a>: React web app to explore USPS Zone profile of Origin ZIP3 (The first 3 digits of a Zip code). The Zone between an Origin and Destination zipcode determines how much a customer is expected to pay for the package delivery. 
